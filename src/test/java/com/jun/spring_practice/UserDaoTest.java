...
public class UserDaoTest {
	...
	@Before
	public void setUp() {
		this.user1 = new User("2", "park", "springno1", Level.BASIC, 1, 0);
		this.user2 = new User("3", "lee", "springno2", Level.SILVER, 55, 10);
		this.user3 = new User("1", "kim", "springno3", Level.GOLD, 100, 40);
	}
